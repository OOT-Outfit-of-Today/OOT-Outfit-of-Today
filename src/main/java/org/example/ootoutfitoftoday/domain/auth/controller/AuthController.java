...
public interface AuthController {
    ...
    @Operation(
            ...
            description = """
                    회원가입 시 로그인 ID의 중복 여부를 실시간으로 확인합니다.
    ...
    @Operation(
            summary = "이메일 중복 체크",
            description =  """
                    회원가입 시 이메일의 중복 여부를 실시간으로 확인합니다.
    ...
    @Operation(
            summary = "닉네임 중복 체크",
            description = """
                    회원가입 시 닉네임의 중복 여부를 실시간으로 확인합니다.
    ...
    @Operation(
            summary = "전화번호 중복 체크",
            description =  """
                    회원가입 시 전화번호의 중복 여부를 실시간으로 확인합니다.
    ...
    @Operation(
            summary = "토큰 재발급",
            description = """
                    리프레시 토큰을 사용하여 새로운 액세스 토큰과 리프레시 토큰을 발급합니다.(RTR)
    ...
    @Operation(
            ...
            description = """
                    OAuth2 로그인 후 발급된 임시 코드를 JWT 토큰으로 교환합니다.
    ...
    @Operation(
            summary = "로그아웃",
            description = """
                    특정 디바이스에서 로그아웃하고 리프레시 토큰을 무효화합니다.
