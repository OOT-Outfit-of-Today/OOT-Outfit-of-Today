...
public enum ClothesSuccessCode implements SuccessCode {
    ...
    CLOTHES_OK("CLOTHES_OK", HttpStatus.OK, "옷을 조회하였습니다."),
    CLOTHES_UPDATE("CLOTHES_UPDATE", HttpStatus.OK, "옷을 수정하였습니다."),
    CLOTHES_DELETE("CLOTHES_DELETE", HttpStatus.OK, "옷을 삭제하였습니다.");
